% weather-cli(SECTION) | User Commands
%
% "March  4 2026"
...
weather-cli - program to do something

# SYNOPSIS

**weather-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**weather-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **weather-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**weather-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    weather-cli. See **foo.conf**(5) for further details.
...
**weather-cli** provides some return codes, that can be used in scripts:
